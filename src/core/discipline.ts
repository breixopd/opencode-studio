...
export function buildDisciplinePrompt(): string {
  ...
  parts.push("- Session spend cap: soft default $5 until confirmed; set with studio_preferences set_session_budget <usd> or /budget 5")
  parts.push("- Disable spend cap: set_session_budget 0 / disable_budget:true / say \"disable budget\" / /budget off")
  parts.push("- First-run: studio_setup({ action: \"onboard\", budget_usd: 5 }) or disable_budget: true — ask user once if unconfirmed")
  parts.push("")
