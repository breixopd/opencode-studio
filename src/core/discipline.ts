...
export function buildDisciplinePrompt(): string {
  ...
  parts.push("- Session spend cap: default $5; studio_preferences set_session_budget <usd> (0=unlimited; or say \"budget $5\")")
  parts.push("- First-run: studio_setup({ action: \"onboard\" }) for prefer_local + budget defaults")
  parts.push("")
